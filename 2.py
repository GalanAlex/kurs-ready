...
class Ui_MainWindow(QWidget):
    def setupUi(self, MainWindow):
        ...
        self.horizontalSlider.setMaximum(cgs.K-1)
        ...
        self.horizontalSlider_2.setMaximum(cgs.J-1)
        ...
        self.doubleSpinBox_5.setValue(int(cgs.J))
        ...
        self.doubleSpinBox_6.setValue(int(cgs.K))
    ...
    def valuechange_J(self):
        CustomWidget1.J = int(self.doubleSpinBox_5.value())
        #CustomWidget1.K = int(self.doubleSpinBox_6.value())
        #cgs.J =
    ...
    def valuechange_K(self):
        #CustomWidget1.J = int(self.doubleSpinBox_5.value())
        CustomWidget1.K = int(self.doubleSpinBox_6.value())        #self.horizontalSliderT.setMaximum(cgs.K)
